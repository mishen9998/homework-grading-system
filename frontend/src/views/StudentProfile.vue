      ...
      <div class="avatar-section">
        <div class="avatar-wrapper" @click="triggerAvatarUpload">
          ...
          <div v-else class="avatar">
            <span>{{ authStore.user?.name?.charAt(0) || '学' }}</span>
          </div>
        ...
        <p class="student-id">学号：{{ authStore.user?.student_id || '未填写' }}</p>
      </div>
      <button @click="handleLogout" class="logout-btn">退出登录</button>
    </div>

    <div class="quick-actions">
      <router-link to="/student/schedule" class="action-card">
        <span class="action-icon">📅</span>
        <div class="action-info">
          <span class="action-title">我的课表</span>
          <span class="action-desc">查看本周课程安排</span>
        </div>
      ...
      <div class="section">
        ...
        <div class="info-list">
          ...
          <div class="info-item">
            ...
            <span v-if="!isEditing" class="value">{{ authStore.user?.student_id || '未填写' }}</span>
            <input v-else v-model="form.student_id" type="text" class="edit-input" placeholder="如：202613142601" />
          </div>
          <div class="info-item">
          ...
          <div class="info-item">
            ...
            <span v-if="!isEditing" class="value">{{ authStore.user?.class_name || '未填写' }}</span>
            <input v-else v-model="form.class_name" type="text" class="edit-input" placeholder="如：计算机2301班" />
          </div>
          <div class="info-item">
            <span class="label">QQ号</span>
            <span v-if="!isEditing" class="value">{{ authStore.user?.qq || '未填写' }}</span>
            <input v-else v-model="form.qq" type="text" class="edit-input" placeholder="请输入QQ号" />
          </div>
          <div class="info-item">
